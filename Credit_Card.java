...
public class Credit_Card extends Bank_Card
{
   ...
   public Credit_Card(int Card_Id,String Client_Name,String Issuer_Bank,String Bank_Account,Double Balance_Amount,
   int CVC_Number,double Interest_rate,String Expiration_Data){
   ...
   public void setCredit_limit(int newCredit_limit, int newGrace_period){
